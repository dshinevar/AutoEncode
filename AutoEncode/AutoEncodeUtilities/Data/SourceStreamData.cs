...
public class SourceStreamData(int durationInSeconds, int numberOfFrames, VideoStreamData videoStream, IEnumerable<AudioStreamData> audioStreams, IEnumerable<SubtitleStreamData> subtitleStreams)
{
